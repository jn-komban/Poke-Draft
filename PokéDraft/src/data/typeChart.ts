...
// Damage multiplier when an ATTACKER of [type] hits a DEFENDER of [type].
...
// Effectiveness of an attacking type vs a defender with possibly two types.
export function effectiveness(attacker: PokeType, defenderTypes: PokeType[]): number {
  let mult = 1;
